 ...
 */
/*
 * About the imported source:
 * Originally this used __darwin_natural_t, which as you have guessed
 * is darwin exclusive and this isn't darwin, however, an equivalent for this
 * is uint32_t, so basically it can cope harder.
*/
